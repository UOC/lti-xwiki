...
public class LTIAuthServiceImpl extends XWikiAuthServiceImpl {
    ...
    public Principal authenticate(String username, String password, XWikiContext context) throws XWikiException {
        ...
        if (!context.getAction().equalsIgnoreCase("logout")) {
            ...
            URL urlresource = XWiki.class.getClassLoader().getResource("../authorizedConsumersKey.properties");
            if (urlresource != null) {
                //2. Check if LTI call is valid
                LTIEnvironment ltiEnvironment = new LTIEnvironment(urlresource.toString());
                ...
                logger.log(Level.SEVERE, "[{0}] Error LTI Authentication can't load authorizedConsumersKey.properties, sould be in WEB-INF folder", new Object[]{wikiNameShow});
            }
    ...
    /**
     * Creates the user if he/she doesn't exist in the XWiki repository. User is
     * assigned to the default XWikiAllGroup
     *
     * @param user
     * @param context
